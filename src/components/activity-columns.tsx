...
export const columns: ColumnDef<Activity>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="text-right font-medium">{formatDistanceInKm(row.getValue("distance"))}</div>
    },
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="text-right font-medium">{formatDuration(row.getValue("movingTime"))}</div>
    },
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="text-right font-medium">{formatDuration(row.getValue("elapsedTime"))}</div>
    },
  },
  {
    ...
    cell: ({ row }) => {
      const speed = parseFloat(row.getValue("averageSpeed"))
